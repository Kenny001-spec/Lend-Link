      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center relative z-10">
        ...
        >
          <div className="relative inline-block mb-6">
            ...
            />
            <h1 className="relative text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-violet-400 to-purple-400">
              Decentralized
              <br />
              Micro-Loans
              <motion.span 
          ...
          >
            Experience the future of lending on CrossFI blockchain. Secure, transparent, and lightning-fast micro-loans powered by smart contracts.
          </motion.p>
          ...
          >
            {[
              ...
              { Icon: Users, text: "P2P", color: "text-blue-400" }
        ...
        >
          <div className="relative w-full h-96 bg-gradient-to-br from-blue-900/30 to-violet-900/30 rounded-2xl backdrop-blur-xl border border-white/10">
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
              className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-violet-500/20 rounded-2xl"
            />
